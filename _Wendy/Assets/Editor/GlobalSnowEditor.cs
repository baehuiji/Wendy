...
namespace GlobalSnowEffect {
    ...
    public class GlobalSnowEditor : Editor {
        ...
        SerializedProperty snowfall, snowfallIntensity, snowfallSpeed, snowfallDistance, snowfallUseIllumination, snowfallReceiveShadows, cameraFrost, cameraFrostIntensity, cameraFrostSpread, cameraFrostDistortion;
        ...
        SerializedProperty forceForwardRenderingPath, floatingPointNormalsBuffer, allowBatchedMeshes, showCoverageGizmo, smoothness, snowAmount, altitudeBlending, enableWMAPI;
        ...
        void OnEnable() {
            ...
            allowBatchedMeshes = serializedObject.FindProperty("_allowBatchedMeshes");
        ...
        public override void OnInspectorGUI() {
            ...
            if (expandSection[SCENE_SETTINGS]) {
                ...
                if (deferred && !gs.forceForwardRenderingPath) {
                    ...
                    EditorGUILayout.PropertyField(allowBatchedMeshes, new GUIContent("Allow Batched Meshes", "This option is used when excluding objects. When it's enabled, combined meshes from static or dynamic batching can be used. When disabled, Global Snow will use the mesh from the collider if it exists."));
